...
use Mesd\NotificationBundle\Entity\Notification;
use Mesd\NotificationBundle\Form\NotificationType;
...
class NotificationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MesdNotificationBundle:Notification')->findAll();

        return $this->render('MesdNotificationBundle:Notification:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MesdNotificationBundle:Notification:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MesdNotificationBundle:Notification')->find($id);
        ...
        return $this->render('MesdNotificationBundle:Notification:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MesdNotificationBundle:Notification:edit.html.twig', array(
            'entity'      => $entity,
