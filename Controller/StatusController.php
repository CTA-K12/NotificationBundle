...
use Mesd\NotificationBundle\Entity\Status;
use Mesd\NotificationBundle\Form\StatusType;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MesdNotificationBundle:Status')->findAll();

        return $this->render('MesdNotificationBundle:Status:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MesdNotificationBundle:Status:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MesdNotificationBundle:Status')->find($id);
        ...
        return $this->render('MesdNotificationBundle:Status:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MesdNotificationBundle:Status:edit.html.twig', array(
            'entity'      => $entity,
